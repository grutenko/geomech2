...
from .actions import ID_OPEN_DISCHARGE, ID_OPEN_DOCUMENTS, ID_OPEN_PM, ID_OPEN_ROCK_BURST_TREE, ID_OPEN_TREE
...
class MainToolbar(wx.ToolBar):
    def __init__(self, parent):
        ...
        self.AddSeparator()
        self.AddCheckTool(ID_OPEN_PM, "ФМС", get_icon("folder"))
